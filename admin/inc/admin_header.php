...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-heading">Pages</li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="sub-category.php">
          <i class="bi bi-person"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="user-queries.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="finishes.php">
          <i class="bi bi-palette"></i>
          <span>Finishes</span>
        </a>
      </li><!-- End Finishes Page Nav -->
