...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO products 
            (product_name, category, sub_category, description, pricing, product_image, image2, image3) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->execute([
            $product_name, 
            $category, 
    ...
    <div class="card-body">
      ...
      <form method="POST" action="" enctype="multipart/form-data">
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="mb-3 row">
              <label for="product_image" class="col-sm-4 col-form-label">Main Image *</label>
              <div class="col-sm-8">
                <input type="file" class="form-control mb-2" name="product_image" id="product_image" accept="image/*" required>
                <small class="text-muted">This will be the primary image displayed</small>
              </div>
            </div>
            
            <div class="mb-3 row">
              <label for="product_image2" class="col-sm-4 col-form-label">Additional Image 1</label>
              <div class="col-sm-8">
                <input type="file" class="form-control mb-2" name="product_image2" id="product_image2" accept="image/*">
                <small class="text-muted">Optional second image</small>
              </div>
            </div>
            
            <div class="mb-3 row">
              <label for="product_image3" class="col-sm-4 col-form-label">Additional Image 2</label>
              <div class="col-sm-8">
